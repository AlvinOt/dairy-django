...
urlpatterns = [
    ...
    path('<slug:slug>/add-cow/', views.add_cow_view, name='add_cow'),
    ...
    path('<slug:slug>/cows/<int:cow_id>/add-milking-session/', views.add_milking_session_view, name='add_milking_session'),
